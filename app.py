...
if check_password():
    ...
    if biomarkers_in_top_quintile == 1:
        st.write("Over a 30-year period with 1 biomarker elevated, an individual is :red[1.38] times more likely to have a major cardiovascular event, :red[1.54] times more likely to have coronary heart disease, and :red[1.14] times more likely to have a stroke.")
    elif biomarkers_in_top_quintile == 2:
        st.write("Over a 30-year period with 2 biomarkers elevated, an individual is :red[1.68] times more likely to have a major cardiovascular event, :red[1.98] times more likely to have coronary heart disease, and :red[1.63] times more likely to have a stroke.")
    elif biomarkers_in_top_quintile == 3:
        st.write("Over a 30-year period with 3 biomarkers elevated, an individual is :red[3.21] times more likely to have a major cardiovascular event, :red[4.08] times more likely to have coronary heart disease, and :red[2.87] times more likely to have a stroke.")
    elif biomarkers_in_top_quintile == 0:
        st.write("Over a 30-year period with no biomarkers elevated, an individual has :red[no increased risk] beyond the referent group of major cardiovascular events, coronary heart disease, or stroke.")
