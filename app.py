...
if check_password():
    ...
    if biomarkers_in_top_quintile == 0:
        ...
        st.write("**First Major Cardiovascular Event:** :red[**HR=1.38**] (95% CI: 1.25-1.51)")
        st.write("**Coronary Heart Disease Events:** :red[**HR=1.54**] (95% CI: 1.35-1.75)")
        st.write("**Stroke Events:** :red[**HR=1.14**] (95% CI: 0.96-1.34)")
    elif biomarkers_in_top_quintile == 2:
        st.write("**First Major Cardiovascular Event:** :red[**HR=1.68**] (95% CI: 1.46-1.93)")
        st.write("**Coronary Heart Disease Events:** :red[**HR=1.98**] (95% CI: 1.65-2.39)")
        st.write("**Stroke Events:** :red[**HR=1.63**] (95% CI: 1.28-2.06)")
    elif biomarkers_in_top_quintile == 3:
        st.write("**First Major Cardiovascular Event:** :red[**HR=3.21**] (95% CI: 2.41-4.27)")
        st.write("**Coronary Heart Disease Events:** :red[**HR=4.08**] (95% CI: 2.88-5.77)")
        st.write("**Stroke Events:** :red[**HR=2.87**] (95% CI: 1.71-4.84)")
